 ...
 * 
 *         Esta clase cumple con la normativa actual espa�ola.
 * 
...
public class GeneradorNIFE {
	...
	/**
	 * Obtiene un n�mero de DNI
	 * 
	 * @return Un n�mero de DNI consta de 7 d�gitos + 1 car�cter de control
	 */
	...
	/**
	 * C�lculo de la letra del DNI/NIF
	 * 
	 * @param dni
	 * @return
	 */
